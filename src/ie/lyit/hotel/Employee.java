...
public class Employee extends Person implements Payable {
 ...
 public String toString(){
	...
	public Date getDateProbationEnds(int noDaysProbation){
		// Create dateProbationEnds as a copy of startDate
		Date dateProbationEnds=startDate;
		// setDay() of dateProbationEnds to getDay() + noDaysProbation
		dateProbationEnds.setDay(dateProbationEnds.getDay()+noDaysProbation);
		System.out.println(dateProbationEnds);
		// Check if dateProbationEnds getDay() > 31, if so...
		if(dateProbationEnds.getDay() > 31) {
			// ... subtract 31 from dateProbationEnds getDay() and...
			dateProbationEnds.setDay(dateProbationEnds.getDay()-31);
			// ... increment dateProbationEnds getMonth()
			dateProbationEnds.setMonth(dateProbationEnds.getMonth()+1);
		}
		System.out.println(dateProbationEnds);
		// and return dateProbationEnds 20/2/2009
